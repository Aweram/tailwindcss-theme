...
@php
    $baseClass = "inline-flex justify-center items-center flex-nowrap border-btn";
    ...
    elseif ($warning) $colorClass = "bg-warning border-warning text-white hover:bg-warning/75 hover:border-warning/75";
    elseif ($outlineWarning) $colorClass = "bg-transparent border-warning text-warning hover:bg-warning/10";

    elseif ($info) $colorClass = "bg-info border-info text-white hover:bg-info/75 hover:border-info/75";
